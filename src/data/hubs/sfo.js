export const sfo = {
  ...
  "faqSchema": [
    ...
    },
    {
      ...
      "answer": "Starlink satellite WiFi is free for all MileagePlus members, gate to gate. Over 425 United aircraft were equipped as of mid-2026 (about 24% of the combined fleet). The rollout began with United Express regional jets — Embraer 175s from May 2025 — and over half the regional fleet is now equipped; the first mainline Starlink aircraft (a Boeing 737-800) entered service in October 2025 and the first widebody in June 2026, with the full widebody fleet expected by summer 2027. Check The Blue Board's Fleet tab to see whether your specific tail number is equipped."
    },
    {
